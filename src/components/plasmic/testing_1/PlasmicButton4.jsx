...
import sty from "./PlasmicButton4.module.css"; // plasmic-import: La5RNhmeI5M7n/css

export const PlasmicButton4__VariantProps = new Array("type", "border", "size");

export const PlasmicButton4__ArgProps = new Array();
