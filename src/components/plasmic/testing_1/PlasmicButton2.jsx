...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: fjWsrVR-OAtum/css

export const PlasmicButton2__VariantProps = new Array("type", "border", "size");
